...
module Sorcery
  ...
  module Controller
    ...
    module InstanceMethods
      ...
      # instead the element. In this case, it would return the symbol of the
      # login source method rather than the return value from the block. That's
      # why we must use the result placeholder variable.
      #
